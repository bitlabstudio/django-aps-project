"""Django settings for the aps_project project."""
import os
...
STATICFILES_DIRS = (
    ...
    os.path.join(DJANGO_PROJECT_ROOT, 'aps_project/static'),
)
...
ROOT_URLCONF = 'aps_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'aps_project.wsgi.application'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(DJANGO_PROJECT_ROOT, 'aps_project/templates')
)
